    ...
    <nav class="navbar navbar-default navbar-fixed">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Edit Rumah Sakit</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="content">
                            <form action="/hospital/{{$hospital->id}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                    <label for="provinsi">Provinsi</label>
                                    <select name="provinsi" id="provinsi" class="form-control">
                                        @foreach ($provinsis['rajaongkir']['results'] as $prov)
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea name="hospital" id="hospital" class="form-control ckeditor">{{old('hospital') ? old('hospital') : $hospital->hospital}}</textarea>
                                </div>
