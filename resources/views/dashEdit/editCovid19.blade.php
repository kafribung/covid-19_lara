                        ...
                        <div class="content">
                            ...
                            <form action="/covid/{{$covid->id}}" method="POST">
                                ...
                                <div class="form-group">
                                  <label for="info">Info Covid-19</label>
                                  <textarea name="info" id="info" class="form-control ckeditor">{{old('info') ? old('info') : $covid->info }}</textarea>
                                </div>

                                @if ($errors->has('info'))
                                    <p class="alert alert-danger">{{$errors->first('info')}}</p>
                                @endif
