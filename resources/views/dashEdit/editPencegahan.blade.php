        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Edit Pencegahan</h4>
                            <hr>
                        </div>
                        <div class="content">

                            <form action="/cegah/{{$pencegahan->id}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                  <label for="pencegahan">pencegahan Covid-19</label>
                                  <textarea name="pencegahan" id="pencegahan" class="form-control ckeditor">{{old('pencegahan') ? old('pencegahan') : $pencegahan->pencegahan }}</textarea>
                                </div>
